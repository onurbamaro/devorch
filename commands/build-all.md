...
Read `$CLAUDE_HOME/commands/devorch/build.md` once — this is the build instructions template.
...
- **Context discipline**: build-all is a thin supervisor. It does NOT launch builders, poll tasks, manage waves, or run validation directly. All of that is delegated to the per-phase Task agent which follows build.md instructions.
